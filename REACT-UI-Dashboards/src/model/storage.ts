import { AppState, CaseItem, Incident, EvidenceItem, DeadlineItem } from './types';
...
const seedDeadline: DeadlineItem = {
  id: 'deadline-1',
  case_id: 'case-1',
  case_title: 'Räumung Pullach',
  label: 'Fristverlängerung',
  due_date: formatISO(addDays(new Date(), 10), { representation: 'date' }),
  due_in_business_days: 8,
  status: 'soon',
  next_action: 'Fristverlängerung beim Gericht beantragen.',
};
